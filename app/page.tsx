...
const aiRecommendations = [
  {
    ...
    description:
      "Weather conditions favor apple scab development. Apply fungicide (Captan 50WP) within 24-48 hours.",
  ...
  },
  {
    ...
    description:
      "Fruit diameter reaching 10-12mm. Begin chemical thinning in 5-7 days for optimal yield.",
  ...
  },
  {
    ...
    description:
      "Market prices projected to peak at $3.25/kg in 3 weeks. Current ripeness: 67%.",
  ...
  function OverviewContent() {
    return (
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h2 className="heading-lg text-foreground">
              Virtual Agriculture Advisor
            </h2>
            <p className="body-lg text-muted-foreground mt-1">
              AI-powered insights for your 50-hectare apple orchard • 12,500
              trees
            </p>
          </div>
            ...
            <div className="flex items-center space-x-2">
              <div className="flex items-center bg-orange-50 px-2 py-1 rounded text-xs border border-orange-200">
                ...
                <span className="font-bold text-orange-800">
                  {orchardMetrics.diseaseRisk.overall.level} Risk
                </span>
              </div>
              <Button
                size="sm"
                variant="outline"
                className="btn-outline-ag text-xs"
              >
          ...
          <div className="farm-grid-2">
            ...
            <div className="card-status critical">
              ...
              <div className="space-y-4">
                <div className="metric-display text-red-600">
                  {orchardMetrics.diseaseRisk.appleScab.probability}%
                </div>
                <div className="flex items-center justify-between">
                  <span className="body-md font-semibold">Risk Level</span>
                  <span className="metric-display-sm text-red-600">
                    {orchardMetrics.diseaseRisk.appleScab.risk}
                  </span>
                </div>
                <div className="text-xs font-bold text-red-800 bg-red-50 px-2 py-1 rounded">
                  Action: Spray in{" "}
                  {orchardMetrics.diseaseRisk.appleScab.nextSprayWindow}
                </div>
                <div className="progress-agricultural">
                  <div
                    className="progress-fill-warning"
                    style={{
                      width: `${orchardMetrics.diseaseRisk.appleScab.probability}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-green-600 text-sm">
                    {orchardMetrics.diseaseRisk.fireBlight.probability}%
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-yellow-600 text-sm">
                    {orchardMetrics.diseaseRisk.powderyMildew.probability}%
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-green-600 text-sm">
                    {orchardMetrics.diseaseRisk.cedarAppleRust.probability}%
                  </span>
                </div>
                ...
                <div className="mt-3 p-2 bg-blue-50 rounded text-xs">
                  ...
                  <span className="text-blue-700 ml-1">
                    94% based on weather, sensors & historical data
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          <h3 className="heading-md text-foreground">
            Orchard Intelligence Dashboard
          </h3>
              ...
              <div className="text-center space-y-2">
                ...
                <div className="flex items-center justify-center bg-green-50 px-1 py-0.5 rounded text-xs">
                  <span className="font-bold text-green-600">
                    {orchardMetrics.yieldPrediction.estimated.confidence}%
                    confidence
                  </span>
                </div>
              </div>
              ...
              <div className="text-center space-y-2">
                ...
                <div>
                  <div className="text-lg md:text-xl font-black text-orange-600 tabular-nums">
                    {
                      orchardMetrics.yieldPrediction.harvestOptimal
                        .daysRemaining
                    }
                    d
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        size="sm"
                        variant="ghost"
                        className="text-xs px-2 py-1.5 h-auto font-bold"
                      >
                        Mark Complete
                      </Button>
                    </div>
            ...
            <div className="card-agricultural">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="metric-display-sm text-green-600">
                      99.9%
                    </span>
                    <div className="progress-agricultural mt-1 w-16">
                      <div
        ...
        <div className="farm-grid">
          {sensorData.map((sensor) => {
            ...
            const getStatusText = () => {
              switch (sensor.id) {
                case "leafWetness":
                  return sensor.diseaseRisk;
                case "temperature":
                  return sensor.growthImpact;
                case "humidity":
                  return sensor.sprayCondition;
                case "light":
                  return sensor.photosynthesis;
                default:
            ...
            return (
              <div
                key={sensor.id}
                className={`card-status ${getStatusColor()}`}
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div
                    ...
                    <div>
                      <h4 className="heading-sm text-foreground">
                        {sensor.name}
                      </h4>
                      <p className="body-md text-muted-foreground text-xs">
                        {sensor.lastReading}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-blue-800 mt-1">
                      Section D sensors recalibrated
                    </p>
    ...
    const generateTrees = () => {
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          else if (randomHealth > 0.7) health = "warning";
    ...
    return (
      ...
      >
        ...
        <div className="farm-grid">
          <div className="card-status healthy">
            ...
            <div className="flex items-end space-x-2">
              <span className="metric-display text-green-600">
                {orchardMetrics.orchardStatus.healthyTrees}
              </span>
              <span className="text-sm font-semibold text-green-600 mb-1">
                {Math.round(
                  (orchardMetrics.orchardStatus.healthyTrees /
                    orchardMetrics.orchardStatus.totalTrees) *
                    100
                )}
                %
              </span>
          ...
          <div className="card-status warning">
            ...
            <div className="flex items-end space-x-2">
              <span className="metric-display text-yellow-600">
                {orchardMetrics.orchardStatus.atRiskTrees}
              </span>
          ...
          <div className="card-status critical">
            ...
            <div className="flex items-end space-x-2">
              <span className="metric-display text-red-600">
                {orchardMetrics.orchardStatus.diseasedTrees}
              </span>
          ...
          <div className="card-agricultural">
            ...
            <span className="metric-display text-primary">
              {orchardMetrics.orchardStatus.totalTrees}
            </span>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="card-agricultural p-6">
            <div
              className="relative bg-green-50 rounded-xl p-4 overflow-auto"
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-muted-foreground">
                Click on individual trees to view detailed health reports and
                fruit count estimates
              </p>
            </div>
          </div>
        </div>
