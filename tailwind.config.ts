  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        'creative': ['var(--font-fredoka)', 'var(--font-poppins)', 'ui-sans-serif', 'system-ui', 'sans-serif'],
      },
      colors: {
        ...
        'healthy-tree': "hsl(var(--healthy-tree))",
        'warning-tree': "hsl(var(--warning-tree))",
        'diseased-tree': "hsl(var(--diseased-tree))",
